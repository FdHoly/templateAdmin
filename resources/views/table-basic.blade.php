                ...
                <ul class="navbar-nav mr-auto hidden-xs">
                    <li class="nav-item page-header">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Form Markdown</li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="main_content" id="main-content">
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Basic Table</a>
                    ...
                    <div class="col-lg-12">
                        <div class="separate-title">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Bootstrap">Bootstrap</a></li>
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#More-table">More</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="cl2">&nbsp;</label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="cl3">&nbsp;</label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label" for="cl4">&nbsp;</label>
                                                            </div>
                                                        </td>
                                                        <td>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="body table-responsive">
                                        <table class="table table-hover mb-0 va_center">
                                            <thead>
                                                <tr>
                                                    <th>Media</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="text-success">23 <i class="fa fa-long-arrow-up"></i></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="text-danger">-9 <i class="fa fa-long-arrow-down"></i></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">Instagram Post</h6>
                                                    ...
                                                    <td class="text-right">
                                                        <div class=" text-success">16 <i class="fa  fa-long-arrow-up"></i></div>
                                                        <div class="text-muted">up</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">LinkedIn Post</h6>
                                                        <span>1k Follows, 228 Likes</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-right">
                                                        <div class=" text-success">27 <i class="fa  fa-long-arrow-up"></i></div>
                                                        <div class="text-muted">up</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>10K</td>
                                                        <td>
                                                            <span class="badge badge-success text-uppercase">2341</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>21K</td>
                                                        <td>
                                                            <span class="badge badge-success text-uppercase">952</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>8K</td>
                                                        <td>
                                                            <span class="badge badge-success text-uppercase">6127</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>154</td>
                                                        <td>
                                                            <span class="badge badge-success text-uppercase">325</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>200</td>
                                                        <td>
                                                            <span class="badge badge-success text-uppercase">160</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="body">                          
                                        <div class="table-responsive">
                                            <table class="table mb-0 table-hover va_center">
                                                <thead>
                                                    <tr>                                    
                                                        <th>Application</th>
                                                        <th>Team</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="sparkbar-mini">5,8,6,3,5,9,2</span>
                                                        </td>
                                                        <td>11,200</td>
                                                        <td>$83</td>
                                            ...
                                            <table class="table table-hover mb-0 va_center">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="sparkbar-mini">5,8,6,3,5,9,2</span></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="sparkbar-mini">8,2,1,5,-2,6,-4</span></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="sparkbar-mini">2,3,3,-2,-8,4,8</span></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="sparkbar-mini">5,5,5,6,3,2,1</span></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <table class="table va_center mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Dispatched</td>
                                                        <td>Credit card</td>
                                                        <td><label class="badge badge-primary text-uppercase">Approved</label></td>
                                                        <td>
                                                            <a href="javascript:void(0);" class="btn btn-success btn-sm">View Order</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><label class="badge badge-primary text-uppercase">Pending</label></td>
                                                        <td>
                                                            <a href="javascript:void(0);" class="btn btn-success btn-sm">View Order</a>
                                                            <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><label class="badge badge-primary text-uppercase">Rejected</label></td>
                                                        <td>
                                                            <a href="javascript:void(0);" class="btn btn-success btn-sm">View Order</a>
                                                            <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                                        </td>
...
<script>
    $('.sparkbar-mini').sparkline('html', { type: 'bar', height: '18px', barWidth: 5, barSpacing: 2 });
</script>
</body>
</html>
